 ...
 * @author admin
 */
@WebServlet(name = "Authorized", urlPatterns = {"/authorized.do"})
public class Authorized extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!authorized) {
            ...
            response.sendRedirect("/citymanager/destinationpage.do");
        }
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Authorized</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Authorized at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
