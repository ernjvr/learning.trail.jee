 ...
 * @author admin
 */
@WebServlet(name = "MainResponderHelper", urlPatterns = {"/mainmenuresponderhelper.do"})
public class MainResponderHelper extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            final String message = String.format("<span>You chose to show the page to %s and set useDB to %b and sendEmail to %b</span>", pageToNavigate, optDB, optEmail);
            out.printf("<html><body><h1>%s</h1></body></html>%n", message);
        }
    }
